...
public class TabelJam_TMA1 extends AbstractTableModel {

    private List<Jam_TMA1> list = new ArrayList<Jam_TMA1>();
    ...
    public Jam_TMA1 get(int baris) {
        return (Jam_TMA1) list.get(baris);
    }
}
