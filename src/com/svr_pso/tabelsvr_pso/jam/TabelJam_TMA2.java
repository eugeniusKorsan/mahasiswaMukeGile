...
public class TabelJam_TMA2 extends AbstractTableModel {

    private List<Jam_TMA2> list = new ArrayList<Jam_TMA2>();
    ...
    public Jam_TMA2 get(int baris) {
        return (Jam_TMA2) list.get(baris);
    }
}
