...
public class TabelJam_TMA3 extends AbstractTableModel {

    private List<Jam_TMA3> list = new ArrayList<Jam_TMA3>();
    ...
    public Jam_TMA3 get(int baris) {
        return (Jam_TMA3) list.get(baris);
    }
}
