...
public class TabelJam_TMA4 extends AbstractTableModel {

    private List<Jam_TMA4> list = new ArrayList<Jam_TMA4>();
    ...
    public Jam_TMA4 get(int baris) {
        return (Jam_TMA4) list.get(baris);
    }
}
