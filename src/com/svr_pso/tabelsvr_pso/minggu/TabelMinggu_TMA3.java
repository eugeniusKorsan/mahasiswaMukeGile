...
public class TabelMinggu_TMA3 extends AbstractTableModel {

    private List<Minggu_TMA3> list = new ArrayList<Minggu_TMA3>();
    ...
    public void add(Minggu_TMA3 data) {
        list.add(data);
    ...
    public Minggu_TMA3 get(int baris) {
        return (Minggu_TMA3) list.get(baris);
    }
}
