...
public class TabelMinggu_TMA4 extends AbstractTableModel {

    private List<Minggu_TMA4> list = new ArrayList<Minggu_TMA4>();
    ...
    public void add(Minggu_TMA4 data) {
        list.add(data);
    ...
    public Minggu_TMA4 get(int baris) {
        return (Minggu_TMA4) list.get(baris);
    }
}
