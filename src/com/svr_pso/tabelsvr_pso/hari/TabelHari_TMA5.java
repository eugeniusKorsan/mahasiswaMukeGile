...
public class TabelHari_TMA5 extends AbstractTableModel {

    private List<Hari_TMA5> list = new ArrayList<Hari_TMA5>();
    ...
    public void add(Hari_TMA5 data) {
        list.add(data);
    ...
    public Hari_TMA5 get(int baris) {
        return (Hari_TMA5) list.get(baris);
    }
}
