...
public class TabelHari_TMA2 extends AbstractTableModel {

    private List<Hari_TMA2> list = new ArrayList<Hari_TMA2>();
    ...
    public void add(Hari_TMA2 data) {
        list.add(data);
    ...
    public Hari_TMA2 get(int baris) {
        return (Hari_TMA2) list.get(baris);
    }
}
