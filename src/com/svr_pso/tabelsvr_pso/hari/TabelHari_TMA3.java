...
public class TabelHari_TMA3 extends AbstractTableModel {

    private List<Hari_TMA3> list = new ArrayList<Hari_TMA3>();
    ...
    public void add(Hari_TMA3 data) {
        list.add(data);
    ...
    public Hari_TMA3 get(int baris) {
        return (Hari_TMA3) list.get(baris);
    }
}
